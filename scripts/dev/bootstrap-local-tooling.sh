...
link_local "docs/internal/editor/vscode" ".vscode"
link_local "docs/integrity/SOURCE_SHA256SUMS.txt" "SOURCE_SHA256SUMS.txt"
link_local "scripts/dev/Start Leu.command" "Start Leu.command"
