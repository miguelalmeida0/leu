...
for module, files, extra in [
    ...
    ('ShelfTests', sorted((root / 'ShelfTests').glob('*.swift')),
     onnx + ['-F', str(platform / 'Library/Frameworks'), '-I', str(platform / 'usr/lib')]),
]:
